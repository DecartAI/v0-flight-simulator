...
The codebase was recently refactored for improved maintainability:

### Changes Made
- ✅ Removed 3 unused files (~800 lines)
- ✅ Simplified keyboard handling with key mapping
- ✅ Added debug utility for environment-aware logging
- ✅ Removed 6 unused dependencies (Expo, React Native)
- ✅ Consolidated validation patterns
- ✅ Removed unnecessary RenderController component
...
- ESLint and TypeScript checks are disabled during build for rapid development
- The project auto-syncs with v0.app deployments
- Canvas resolution (1280x704) is a hard requirement for Decart API
- Debug logging only appears in development mode

## 🚢 Deployment

Your project is live at:
**[https://vercel.com/ethanp/v0-3-d-flight-simulator](https://vercel.com/ethanp/v0-3-d-flight-simulator)**

Continue building your app on:
**[https://v0.app/chat/projects/A0Jvrxor06O](https://v0.app/chat/projects/A0Jvrxor06O)**
...
This project is managed through v0.app. To contribute:
